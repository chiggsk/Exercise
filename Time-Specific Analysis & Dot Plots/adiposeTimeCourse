...
ControlIPEIDs <- as.character(intersect(colnames(adiposeCounts), ControlIPEPhenotypes$vial_label))
ControlIPEData <- dplyr::select(adiposeCounts, ControlIPEIDs)

Control7hrIDs <- as.character(intersect(colnames(adiposeCounts), Control7hrPhenotypes$vial_label))
Control7hrData <- dplyr::select(adiposeCounts, Control7hrIDs)

ExerciseIPEIDs <- as.character(intersect(colnames(adiposeCounts), ExerciseIPEPhenotypes$vial_label))
ExerciseIPEData <- dplyr::select(adiposeCounts, ExerciseIPEIDs)

Exercise0.5hrIDs <- as.character(intersect(colnames(adiposeCounts), Exercise0.5hrPhenotypes$vial_label))
Exercise0.5hrData <- dplyr::select(adiposeCounts, Exercise0.5hrIDs)

Exercise1hrIDs <- as.character(intersect(colnames(adiposeCounts), Exercise1hrPhenotypes$vial_label))
Exercise1hrData <- dplyr::select(adiposeCounts, Exercise1hrIDs)

Exercise4hrIDs <- as.character(intersect(colnames(adiposeCounts), Exercise4hrPhenotypes$vial_label))
Exercise4hrData <- dplyr::select(adiposeCounts, Exercise4hrIDs)

Exercise7hrIDs <- as.character(intersect(colnames(adiposeCounts), Exercise7hrPhenotypes$vial_label))
Exercise7hrData <- dplyr::select(adiposeCounts, Exercise7hrIDs)

Exercise24hrIDs <- as.character(intersect(colnames(adiposeCounts), Exercise24hrPhenotypes$vial_label))
Exercise24hrData <- dplyr::select(adiposeCounts, Exercise24hrIDs)

Exercise48hrIDs <- as.character(intersect(colnames(adiposeCounts), Exercise48hrPhenotypes$vial_label))
Exercise48hrData <- dplyr::select(adiposeCounts, Exercise48hrIDs)
...
save(res, file = "adipose_IPECtrl.RData")
...
save(res, file = "adipose_0.5hrCtrl.RData")
...
save(res, file = "adipose_1hrCtrl.RData")
...
save(res, file = "adipose_4hrCtrl.RData")
...
save(res, file = "adipose_7hrCtrl.RData")
...
save(res, file = "adipose_24hrCtrl.RData")
...
setwd("/Users/Chigoziri/MoTrPAC/adipose0.5hr")
load("adipose_0.5hrCtrl.RData")
...
setwd("/Users/Chigoziri/MoTrPAC/adipose1hr")
load("adipose_1hrCtrl.RData")
...
setwd("/Users/Chigoziri/MoTrPAC/adipose4hr")
load("adipose_4hrCtrl.RData")
...
setwd("/Users/Chigoziri/MoTrPAC/adipose7hr")
load("adipose_7hrCtrl.RData")
...
setwd("/Users/Chigoziri/MoTrPAC/adipose24hr")
load("adipose_24hrCtrl.RData")
...
setwd("/Users/Chigoziri/MoTrPAC/adipose48hr")
load("adipose_48hrCtrl.RData")
...
saveWorkbook(ekeggTimeCourseWB, "adiposeTimeCourse_enrichKEGG_FCcutoff1_0.05.xlsx")
saveWorkbook(ekeggEnrichedPathwaysWB,"adiposeTimeCourse_enrichedPathways_FCcutoff1.xlsx")
...
ekeggDotPlotData_filt <- ekeggDotPlotData[ ( !grepl("Epstein-Barr virus infection", ekeggDotPlotData$Description)) & 
                                             ...
                                             ( !grepl("Coronavirus disease - COVID-19", ekeggDotPlotData$Description)), ] 
...
tiff("adiposeTimeDirection_DotPlot_FCcutoff1_supp_0.05.tiff", units="in", width=11, height=8, res=300)

adiposeDotPlot <- ggplot(ekeggDotPlotData_supp, aes(x= Time, y=reorder(Description, dplyr::desc(Description)), size=GeneRatio, color=medianFC, group=Time)) + geom_point(alpha = 0.8) + 
  theme_bw(base_size = 18) + guides(color=guide_colourbar(order=1),size=guide_legend(order=2)) + ylab("Description")
adiposeDotPlot = adiposeDotPlot+scale_color_gradient(low = "red2",  high = "mediumblue", space = "Lab", limit = c(min(ekeggDotPlotData$medianFC),max(ekeggDotPlotData$medianFC)))
adiposeDotPlot+scale_size(range = c(2, 8))

dev.off()

####

tiff("adiposeTimeDirection_filt_DotPlot_FCcutoff1_0.05.tiff", units="in", width=12, height=8, res=300)

adiposeDotPlot <- ggplot(ekeggDotPlotData_filt, aes(x= Time, y=reorder(Description, dplyr::desc(Description)), size=GeneRatio, color=medianFC, group=Time)) + geom_point(alpha = 0.8) + 
  theme_bw(base_size = 18) + guides(color=guide_colourbar(order=1),size=guide_legend(order=2)) + ylab("Description")
adiposeDotPlot = adiposeDotPlot+scale_color_gradient(low = "red2",  high = "mediumblue", space = "Lab", limit = c(min(ekeggDotPlotData_filt$medianFC),max(ekeggDotPlotData_filt$medianFC)))      
adiposeDotPlot+scale_size(range = c(2, 8))
